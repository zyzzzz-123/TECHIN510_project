...
class TaskService {
  ...
  static Future<Task> createTask(int userId, String text, {String type = 'todo', DateTime? dueDate}) async {
  ...
  static Future<void> updateTask(int taskId, {String? text, DateTime? dueDate, String? type}) async {
    final url = Uri.parse('$baseUrl/api/tasks/$taskId');
